...
//   const sendMessage = () => {
//     if (input.trim() !== "") {
//       socket.emit('sendMessage', input, room);
//       setResponses((prev) => [...prev, { message: input, user: true }]);
...
//       setResponses((prev) => [...prev, { message: msg, user: false }]);
//     });
...
//       <p key={index} className={msg.user ? "user-message" : "received-message"}>
//         {msg.message}
//       </p>
//     ))
//   )}
...
const App = () => {
  ...
  //     socket.emit("sendMessage", input, room, username);
  //     setResponses((prev) => [...prev, { message: input, sender: username }]);
  //     setInput("");
  //   } else {
